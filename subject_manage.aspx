                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="subjectList"
                            ...
                            <Columns>
                                <asp:BoundField DataField="subid" HeaderText="Subject Code" HtmlEncode="false" />
                                <asp:BoundField DataField="name" HeaderText="Subject Name" HtmlEncode="false" />
                                <asp:BoundField DataField="total" HeaderText="Total Score" HtmlEncode="false" />
                                <asp:BoundField DataField="createTime" DataFormatString="{0:yyyy-MM-dd}" HeaderText="Create Time" />
                                <asp:TemplateField ShowHeader="False">
                                    <HeaderTemplate>
                                        <asp:Button ID="refreshBT" runat="server" OnClick="refreshBT_Click" Text="Refresh" />
                                    </HeaderTemplate>
                                    <ItemTemplate>
                            ...
                            <div class="insert-form">
                                ...
                                <div class="insert-form-item">
                                 ...
                                 <div class="insert-form-item submit-item">
                                    <asp:Button ID="addBt" runat="server" Text="Add New" CssClass="primary-button" OnClick="addBt_Click" />
                                </div>
                            </div>
                        </div>
                    </ContentTemplate>
