    ...
    public partial class student1 : System.Web.UI.Page
    {
        ...
        private void reloadBaseMsg(string sid)
        {
            ...
            try
            {
                ...
                birthLabel.Text = birth.ToString("yyyy-MM-dd"); // New Zealand commonly uses this date format.

                classLabel.Text = className;
                createTimeLable.Text = createTime.ToString("yyyy-MM-dd HH:mm:ss"); // 24-hour format is commonly used in New Zealand.
