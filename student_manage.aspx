                            ...
                            <div class="list-item">
                                <asp:GridView ID="studentList" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="sid" HeaderText="Student ID" HtmlEncode="false" />
                                        <asp:BoundField DataField="gender" HeaderText="Gender" HtmlEncode="false" />
                                        <asp:BoundField DataField="birth" DataFormatString="{0:yyyy-MM-dd}" HeaderText="Birth Date" />
                                    </Columns>
                ...
                <asp:UpdatePanel runat="server" ID="UpdatePanel2">
                    <ContentTemplate>
                        <div class="select-cont">
                            ...
                            <div class="select-item">
                                <div>
                                    <asp:Button ID="searchBt" runat="server" Text="Search" OnClick="searchBt_Click" CssClass="primary-button" />
                                </div>
                            </div>
                        </div>
                        <div class="list-cont">
                                ...
                                <asp:GridView ID="search_studentList"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Birth Date">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="birthTm" runat="server" Text='<%# Bind("birth", "{0:yyyy-MM-dd}") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                    ...
                    <ContentTemplate>
                        <div class="insert-form">
                            ...
                            <div class="insert-form-item submit-item">
                                <asp:Button ID="addBt" runat="server" Text="Add New" OnClick="addBt_Click" class="primary-button" />
                            </div>
                        </div>
                    </ContentTemplate>
                    <Triggers>
