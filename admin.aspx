...
<head runat="server">
    ...
    <title>SAPMS -  Administrator</title>
...
<body>
    <form id="form1" runat="server">
        <div class="cont">
            <div class="nav">
                <div onclick="navChangeHandle('.navBT1')">Grade Management<asp:Button ID="navBT1" runat="server" Text="" class="navBT navBT1" OnClick="navBT1_Click" /></div>
                <div onclick="navChangeHandle('.navBT2')">Student Management<asp:Button ID="navBT2" runat="server" Text="" class="navBT navBT2" OnClick="navBT2_Click" /></div>
                <div onclick="navChangeHandle('.navBT3')">Class Management <asp:Button ID="navBT3" runat="server" Text="" class="navBT navBT3" OnClick="navBT3_Click" /></div>
                <div onclick="navChangeHandle('.navBT4')">Course Management<asp:Button ID="navBT4" runat="server" Text="" class="navBT navBT4" OnClick="navBT4_Click" /></div>
                <asp:Button ID="outLoginBT" runat="server" Text="Log Out" class="outLoginBT primary-button" OnClick="outLoginBT_Click"/>
            </div>
            <div class="main">
